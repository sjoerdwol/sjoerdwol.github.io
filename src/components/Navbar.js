...
export function Navbar(props) {
  return (
    <nav className='py-10 mb-5 flex justify-between items-center 2xl:pt-16'>
      <h1 className='text-xl text-darkjunglegreen-500 dark:text-platinum-500 font-grestal md:text-3xl xl:text-4xl'>sjoerdwol</h1>
      <ul className='flex items-center'>
        <li><BsFillMoonStarsFill className='cursor-pointer text-3xl text-darkjunglegreen-500 dark:text-platinum-500 md:text-4xl xl:text-5xl' onClick={() => props.setDark(!props.dark)} /></li>
