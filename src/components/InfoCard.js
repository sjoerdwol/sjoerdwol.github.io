export function InfoCard(props) {
  ...
  return (
    <div className=' text-center border-2 border-black rounded-xl p-3 mb-5 last:m-0' >
      <h4 className='pb-4 font-semibold md:text-2xl'>{content.title}</h4>
      <p className='break-words px-5 md:px-10 md:text-xl h-auto xl:px-20 2xl:px-28 3xl:px-36'>{content.description}</p>
